...
public class VentanaAgregarCategoria extends javax.swing.JDialog {
    ...
    public VentanaAgregarCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaAgregarCategoria dialog = new VentanaAgregarCategoria(new javax.swing.JFrame(), true);
