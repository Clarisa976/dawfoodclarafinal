...
('Sushi Nigiri Salmón', 2.50, 'IVA_DIEZ', 50, 1),
('Sushi Uramaki de pollo crujiente', 2.00, 'IVA_DIEZ', 40, 1),
('Ramen Tonkotsu', 5.00, 'IVA_DIEZ', 30, 2),
('Ramen Shoyu', 5.50, 'IVA_DIEZ', 35, 2),
('Pad Thai de Pollo', 6.00, 'IVA_DIEZ', 50, 3),
('Pad Thai de Gambas', 6.50, 'IVA_DIEZ', 45, 3),
...
('Coca cola zero', 2.00, 'IVA_DIEZ', 50, 5),
('Fanta de limon', 2.00, 'IVA_DIEZ', 45, 5),
