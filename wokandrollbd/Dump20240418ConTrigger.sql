...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER control_stock
BEFORE INSERT
ON DetalleTickets FOR EACH ROW
	BEGIN
	   DECLARE stock_actual INT; -- creamos una variable en la que se almacenará el stock actual
	   SELECT stock INTO stock_actual FROM Productos WHERE codProducto = NEW.codProducto;
...
-- Dump completed on 2024-04-18 19:21:10
